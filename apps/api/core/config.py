...
class Settings(BaseSettings):
    ...
    # LLM_PROVIDER : "anthropic" | "openai" | "mistral". LLM_MODEL : surcharge le
    # modèle par défaut du provider (ex. "claude-sonnet-4-6", "gpt-4o",
    # "mistral-large-latest"). Vide = défaut du provider.
