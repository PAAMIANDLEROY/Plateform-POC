      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div className="lg:col-span-1">
          <div className="bg-gray-900 border border-white/10 rounded-2xl p-5 sticky top-24">
            <div className="h-20 bg-gradient-to-br from-primary/20 to-transparent flex items-center justify-center rounded-xl mb-4 text-4xl">
              ⚡
            </div>
        ...
        <div className="lg:col-span-3">
          <div className="bg-gray-900 border border-white/10 rounded-2xl overflow-hidden">
            ...
            <iframe
              src={app.url} title={app.title} className="w-full"
              style={{ height: "75vh" }}
