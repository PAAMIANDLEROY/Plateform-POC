...
import { MarkdownPreview } from "@/components/platform/StudioMarkdown";
import { coursesApi, CourseResponse, CourseBlockResponse, ApiError } from "@/lib/api";
...
export function CoursePageClient({ id }: { id: string }) {
  ...
  useEffect(() => {
    ...
    coursesApi.get(id)
      .then(setCourse)
      .catch((e) => setError(e instanceof ApiError ? e.message : "Cours introuvable"))
        ...
        <div className="lg:col-span-1 order-2 lg:order-1">
          <div className="sticky top-24 bg-gray-900 border border-white/10 rounded-2xl p-5 space-y-4">
            ...
            <div className="space-y-1 text-xs text-gray-500">
              ...
              {course.estimated_duration_minutes > 0 && <p>⏱ {fmtDuration(course.estimated_duration_minutes)}</p>}
