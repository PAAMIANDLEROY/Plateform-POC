      ...
      {block.type === "code" && (
        <>
          <div className="flex items-center gap-3 mb-2">
            <select
              value={(block as any).language ?? "python"}
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`text-sm px-4 py-2 rounded-lg border transition-colors font-medium ${
              preview ? "border-white/30 bg-white/10 text-white" : "border-white/10 text-gray-400 hover:text-white hover:border-white/20"
            }`}
          >
          ...
          {!preview ? (
            ...
            <div className="bg-gray-950 rounded-2xl border border-white/10 p-10">
              <div className="max-w-2xl mx-auto">
                ...
                <div className="flex flex-col gap-5">
                  {blocks.map((block, i) => {
                    if (block.type === "heading") return (block as any).level === 2
                    ...
                    if (block.type === "text") return <p key={i} className="text-gray-300 leading-relaxed">{(block as any).content}</p>;
                    if (block.type === "code") return (
                      <pre key={i} className="bg-gray-900 border border-white/10 rounded-xl p-4 text-sm font-mono text-green-400 overflow-x-auto">
                    ...
                    if (block.type === "key-insight") return (
                    ...
                    if (block.type === "figure" && (block as any).url) return (
                      <figure key={i}>
